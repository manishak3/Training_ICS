...
namespace ASSIGNMENT_5
{
    class SalesDetails
    {
        ...
        {
            SalesDetails obj1 = new SalesDetails(1, 2, 100);
            SalesDetails obj2 = new SalesDetails(2, 3, 250);
            SalesDetails obj3 = new SalesDetails(3, 4, 250);
            SalesDetails obj4 = new SalesDetails(4, 5, 500);
            SalesDetails obj5 = new SalesDetails(5, 6, 600);
